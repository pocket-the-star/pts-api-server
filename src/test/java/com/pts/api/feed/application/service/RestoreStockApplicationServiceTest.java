...
@DisplayName("RestoreStockApplicationService 클래스")
class RestoreStockApplicationServiceTest extends BaseUnitTest {
    ...
    private RestoreStockApplicationService feedService;
    ...
    @BeforeEach
    void setUp() {
        feedService = new RestoreStockApplicationService(feedRepository, dateTimeUtil);
    }
